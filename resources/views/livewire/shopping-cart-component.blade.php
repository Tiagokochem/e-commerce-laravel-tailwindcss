<section>
    ...
    <div class="max-w-3xl mx-auto">
      <header class="flex gap-3 text-center">
        ...
        <ul class="space-y-4">
          @foreach($cartItems as $item)
            <li class="flex items-center gap-4">
              <img src="{{ Storage::url($item->product->image) }}" alt="" class="object-cover rounded size-16" />
          ...
          <div class="w-screen max-w-lg space-y-4">
            ...
            <div class="flex justify-end">
              <span class="inline-flex items-center justify-center rounded-full bg-indigo-100 px-2.5 py-0.5 text-indigo-700">
                ...
                <p class="text-xs whitespace-nowrap">1 Discounts Applied</p>
              </span>
            </div>

            <div class="flex justify-end gap-2">
              <a wire:navigate class="block px-5 py-3 text-sm text-gray-100 transition bg-blue-700 rounded hover:bg-blue-600" href="/">
                  Continue Shopping
                </a>
              <a href="#" class="flex items-center gap-3 px-5 py-3 text-sm text-gray-100 transition bg-gray-700 rounded hover:bg-gray-600">
