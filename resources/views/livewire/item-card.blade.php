<div class="p-1 bg-gray-100 border-blue-400 rounded-lg shadow-sm hover:border">
    ...
    <div>
        ...
        <div class="justify-center block w-full px-12 py-2 text-sm font-medium bg-blue-600 rounded shadow hover:bg-blue-700 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto">
             <a 
            class=""
            href="#"
            >
