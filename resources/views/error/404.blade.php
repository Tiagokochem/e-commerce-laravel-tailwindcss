    ...
    <main id="content">
      <div class="px-4 py-10 text-center sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col items-center justify-center gap-2 mt-5 sm:flex-row sm:gap-3">
          <a wire:navigate class="inline-flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg sm:w-auto gap-x-2 hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="/">
